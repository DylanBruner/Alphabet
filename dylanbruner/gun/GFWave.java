...
import dylanbruner.util.RollingAverage;
...
public class GFWave extends Condition {
    ...
    private void advance() {
        distanceTraveled += MathUtils.bulletVelocity(bulletPower);
    }
    ...
    private int currentBin() {
        int bin = (int) Math
                .round(((Utils.normalRelativeAngle(MathUtils.absoluteBearing(gunLocation, targetLocation) - bearing)) /
