...
public class PatternGunV2 extends Component {
    ...
    // Gun stuff
    static StringBuffer history_base = new StringBuffer(
    ...
    public double doPatternGunV2(ScannedRobotEvent e, double bulletPower) {
        ...
        // This basically converts the current velocity and heading into a character and
        // stores it in the history
        history.insert(0, (char) (int) (Math.sin(e.getHeadingRadians() - absoluteBearing) * e.getVelocity()));
        /*
         * 1. We subtract the absolute bearing from the heading to determine the
         * direction that the enemy is moving.
         * 2. We then multiply that by the velocity.
         * 3. We then take the sine of that value to determine the direction that the
         * enemy is moving. (1 for forward, -1 for backwards)
         * 4. We then cast that value to a char and then insert it into the array.
         * Not sure about this explanation it was auto generated while I was learning
         * how this code works
         */
        ...
        // This plays the pattern for however long we need to aka (distance / bullet
        // velocity)
